    ...
    <>
      ...
      <div className="">
        <div className="default-container  flex-col justify-center">
          <div className="inset-0 absolute  overflow-hidden mt-[115px] z-[-1] mb-5 mx-5">
            <img
              src={bg}
              className="h-full w-full rounded-3xl mx-auto object-cover "
              alt=""
            />
          </div>
          <div className="text-[42pt] lg:text-[52pt] 2xl:text-[90pt] leading-12 md:leading-normal text-center  text-white  mix-blend-difference font-bold">
            <div>
    ...
    <>
      ...
      >
        <div className="rounded-3xl cursor-pointer flex  shadow-indigo-600/50 hover:shadow-lg duration-200 bg-gray-200/50 items-center  overflow-hidden py-5 px-10 hover:scale-101">
          ...
          <div className=" font-bold md:text-[14pt]  text-[10pt] max-w-50 md:max-w-60 leading-5 mb-2">
            {trophy.name}
          </div>
...
const TropyDialog = ({ open, setOpen, selectedTrophy }) => {
  ...
  return (
    <>
      <DialogBox title="" open={open} setOpen={setOpen}>
        <div className="relative">
          <div className="flex items-center flex-wrap lg:flex-nowrap gap-5">
            <div className="w-full place-items-center">
              <img src={selectedTrophy.image} className="" />
            </div>
            <div className="">
              <div className="narrow text-[24pt] leading-8 font-[400]  md:text-[40pt] md:leading-12 ">
                {selectedTrophy.name}
              </div>
              <br />
              <div>{selectedTrophy.description}</div>
              <br />
              <div className="flex flex-wrap gap-2 max-h-[200px] overflow-auto  mb-12">
